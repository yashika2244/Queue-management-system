...
//         localStorage.setItem("signupUserId", res._id); // or res.data._id
...
//         <button
//           type="submit"
//           className="bg-teal-600 text-white  rounded-lg px-12 sm:px-20 py-3 hover:opacity-90 transition shadow-md text-sm sm:text-base"
//         >
//           Start Free Trial
//         </button>
//       </div>
...
//       className="bg-white text-[#27c7a8] px-6 sm:px-8 py-2 sm:py-3 rounded-lg  font-semibold hover:bg-gray-100 transition shadow-md text-sm sm:text-base"
//     >
//       Log In
//     </button>
